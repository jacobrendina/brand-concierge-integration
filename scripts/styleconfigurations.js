window.styleConfiguration = {
  ...
  "text": {
    "welcome.heading": "Not sure where to start? Just ask.",
    "welcome.subheading": "",
  ...
  "arrays": {
    "welcome.examples": [
      {
        "text": "What sock customisation options are available?",
        "systemPrompt": "",
        "imageUrl": "",
        "imageName": "",
        "image": ""
      ...
      {
        "text": "Which sock models are most popular?",
        "systemPrompt": "",
        "imageUrl": "",
        "imageName": "",
        "image": ""
      ...
      {
        "text": "How long does it take to receive the socks?",
        "systemPrompt": "",
        "imageUrl": "",
        "imageName": "",
        "image": ""
  ...
  "theme": {
    ...
    "--color-button-submit": "#b9d590",
    "--color-button-submit-hover": "#b9d590",
    "--input-button-border-radius": "16px",
    "--button-disabled-background": "#b9d590",
    "--disclaimer-color": "#000000",
    "--disclaimer-font-size": "16px",
    "--disclaimer-font-weight": "700",
    "--message-user-background": "#CBDEA0",
    ...
    "--card-text-background": "#cbdea0",
    "--card-text-border-radius": "16px",
    "--card-text-color": "#000000",
    "--card-text-font-size": "14px",
    "--card-text-padding": "8px 10px",
    "--prompt-pill-background": "#CBDEA0",
    "--prompt-pill-border-color": "#CBDEA0",
    "--border-radius-pill": "20px",
    "--prompt-pill-text-color": "#000000",
    "--prompt-pill-button-text-padding": "8px 16px",
    "--chat-container-background": "#E7ECCA",
    "--chat-container-bottom-background": "#E7ECCA",
    "--main-container-bottom-background": "#E7ECCA",
    "--message-blocker-background": "#E7ECCA"
  }
}