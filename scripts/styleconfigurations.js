window.styleConfiguration = {
  ...
  "text": {
    "welcome.heading": "Not sure where to start? Chat with our AI Agent",
  ...
  "arrays": {
    "welcome.examples": [
      {
        "text": "What are the most popular sock materials?",
        "systemPrompt": "",
        "imageUrl": "",
        "imageName": "",
        "image": ""
      ...
      {
        "text": "How are the socks customised?",
        "systemPrompt": "",
        "imageUrl": "",
        "imageName": "",
        "image": ""
      ...
      {
        "text": "How long does the shipping take?",
        "systemPrompt": "",
        "imageUrl": "",
        "imageName": "",
        "image": ""
  ...
  "theme": {
    ...
    "--main-container-background": "#E1F5BC",
    "--input-height": "52px",
    ...
    "--input-focus-outline-color": "#6b6b6b",
    "--input-font-size": "16px",
    "--input-font-weight": "400",
    "--input-text-color": "#000000",
    "--input-button-height": "35px",
    "--input-button-width": "35px",
    "--submit-button-fill-color": "#ffffff",
    "--submit-button-fill-color-disabled": "#ffffff",
    "--color-button-submit": "#000000",
    "--color-button-submit-hover": "#000000",
    "--input-button-border-radius": "5.8px",
    "--button-disabled-background": "#000000",
    "--disclaimer-color": "#000000",
    "--disclaimer-font-size": "16px",
    "--disclaimer-font-weight": "700",
    "--message-user-background": "#D4E1B2",
    ...
    "--card-text-background": "#d4e2b1",
    "--card-text-border-radius": "12px",
    "--card-text-color": "#000000",
    "--card-text-font-size": "14px",
    "--card-text-padding": "8px 10px",
    "--prompt-pill-background": "#D4E1B2",
    "--prompt-pill-border-color": "#D4E1B2",
    "--border-radius-pill": "16px",
    "--prompt-pill-text-color": "#000000",
    "--prompt-pill-button-text-padding": "8px 16px",
    "--chat-container-background": "#e1f5bc",
    "--chat-container-bottom-background": "#e1f5bc",
    "--main-container-bottom-background": "#e1f5bc",
    "--message-blocker-background": "#E1F5BC"
  }
}