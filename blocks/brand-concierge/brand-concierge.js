...
const ALLOY_CONFIG = {
  ...
  onBeforeEventSend: (options) => {
    ...
    options.xdm.web.webPageDetails.name = params.get('title') || document.title || 'your-page-name';
    return true;
  },
};
...
/**
 * Scripts injected at runtime by code already trusted under the CSP nonce
 * are permitted by 'strict-dynamic', so no nonce attribute is required here.
 */
